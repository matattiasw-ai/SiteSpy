...
def main(page: ft.Page):
    page.title = "Hamberera Karl PM - SiteSpy Portfolio"
    ...
    hero = ft.Container(
        ...
        content=ft.Column([
            ...
            ft.Text("Hamberera Karl PM", size=34, weight=ft.FontWeight.W_900, color=TEXT),
            ft.Text("GitHub: karlhamberera | Email: Karlhamberera24@gmail.com", color=MUTED, selectable=True),
            ft.Text("Firestore data model documentation and indexes.", size=16, color=TEXT),
            ft.Text("GitHub profile: https://github.com/karlhamberera", color=GOLD, selectable=True),
        ], spacing=13),
    )
