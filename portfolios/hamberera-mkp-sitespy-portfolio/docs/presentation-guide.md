# Hamberera Karl PM Presentation Guide

## Portfolio Details

- GitHub username: karlhamberera
- Repository: HambereraKarlPMPortfolio
...
My assigned preparation area is: Firestore data model documentation and indexes.
...
I prepared and reviewed work around Firestore data model documentation and indexes.
