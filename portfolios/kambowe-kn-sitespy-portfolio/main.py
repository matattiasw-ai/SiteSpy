...
def main(page: ft.Page):
    ...
    hero = ft.Container(
        ...
        content=ft.Column([
            ...
            ft.Text("GitHub: kambowe | Email: 224085980@students.unam.na", color=MUTED, selectable=True),
            ft.Text("Project CRUD service and project create/edit screens.", size=16, color=TEXT),
            ft.Text("GitHub profile: https://github.com/kambowe", color=GOLD, selectable=True),
        ], spacing=13),
    )
        ...
        ft.Container(
            ...
            content=ft.ResponsiveRow([
                ...
                ft.Container(tile('Contribution Area', [
                    ft.Text("Project CRUD service and project create/edit screens.", color=TEXT),
                ]), col={'xs': 12, 'md': 6}),
