...
def main(page: ft.Page):
    ...
    hero = ft.Container(
        ...
        content=ft.Column([
            ...
            ft.Text("GitHub: Mathias4040 | Email: Mathiasjonas4040@gmail.com", color=MUTED, selectable=True),
            ft.Text("Project history and detail workflow.", size=16, color=TEXT),
            ft.Text("GitHub profile: https://github.com/Mathias4040", color=GOLD, selectable=True),
        ], spacing=13),
    )
        ...
        ft.Container(
            ...
            content=ft.ResponsiveRow([
                ...
                ft.Container(tile('Contribution Area', [
                    ft.Text("Project history and detail workflow.", color=TEXT),
                ]), col={'xs': 12, 'md': 6}),
                ft.Container(tile('Files / Validation Area', [
                    ft.Text('- src/screens/ProjectHistoryScreen.js', color=MUTED, size=13),
                    ft.Text('- src/screens/ProjectDetailsScreen.js', color=MUTED, size=13),
                    ft.Text('- src/services/projectService.js', color=MUTED, size=13),
                ], ACCENT), col={'xs': 12, 'md': 6}),
