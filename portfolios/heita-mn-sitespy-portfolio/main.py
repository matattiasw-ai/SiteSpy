...
def main(page: ft.Page):
    ...
    hero = ft.Container(
        ...
        content=ft.Column([
            ...
            ft.Text("GitHub: marthandilimengungo-dotcom | Email: marthandilimengungo@gmail.com", color=MUTED, selectable=True),
            ft.Text("Validation and loading/error feedback.", size=16, color=TEXT),
            ft.Text("GitHub profile: https://github.com/marthandilimengungo-dotcom", color=GOLD, selectable=True),
        ], spacing=13),
    )
        ...
        ft.Container(
            ...
            content=ft.ResponsiveRow([
                ...
                ft.Container(tile('Contribution Area', [
                    ft.Text("Validation and loading/error feedback.", color=TEXT),
                ]), col={'xs': 12, 'md': 6}),
                ft.Container(tile('Files / Validation Area', [
                    ft.Text('- src/utils/validators.js', color=MUTED, size=13),
                    ft.Text('- src/components/ErrorState.js', color=MUTED, size=13),
                    ft.Text('- src/components/LoadingState.js', color=MUTED, size=13),
                ], ACCENT), col={'xs': 12, 'md': 6}),
